...
INSERT INTO asset.asset_info(code, name, type, max_type, dept, unit, life, amount, use_status, review_status,
                             approval_date)
VALUES ('1', '土地测试a', '商业土地', '土地', '', '宝相公司', 50, 1000000.00, DEFAULT, '已通过', NOW()),
       ('2', '办公室a', '办公室', '房屋', '', '宝相公司', 10, 300000.00, DEFAULT, '已通过', NOW()),
       ('3', '枫园食堂', '食堂', '房屋', '', '宝相公司', 5, 300000.00, DEFAULT, '已通过', NOW()),
       ('4', '烟囱a', '烟囱', '构筑物', '', '宝相公司', 5, 33000.00, DEFAULT, '已通过', NOW()),
       ('5', '围墙a', '围墙', '构筑物', '', '宝相公司', 5, 433000.00, DEFAULT, '已通过', NOW()),
       ('6', '办公桌a', '办公桌', '通用设备', '', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('7', '椅子a', '椅子', '通用设备', '', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('8', '沙发a', '沙发', '通用设备', '', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('9', '空调a', '取暖降温设备', '通用设备', '', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('10', '电脑a', '电脑', '通用设备', '', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('11', '投影仪', '文艺设备', '专用设备', '', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('12', '乒乓球桌', '体育设备', '专用设备', '', '宝相公司', 15, 8000.00, DEFAULT, '已通过', NOW()),
       ('13', '小轿车a', '小轿车', '车辆', '', '宝相公司', 20, 200000.00, DEFAULT, '已通过', NOW()),
       ('14', '货车a', '货车', '车辆', '', '宝相公司', 20, 700000.00, DEFAULT, '已通过', NOW()),
       ('15', '绿萝盆栽', '盆栽', '动植物', '', '宝相公司', 20, 70000.00, DEFAULT, '已通过', NOW()),
       ('16', '花坛', '绿化工程', '在建工程', '', '宝相公司', 20, 700000.00, DEFAULT, '已通过', NOW());



INSERT INTO asset.asset_info(code, name, type, max_type, dept, unit, life, amount, use_status, review_status,approval_date)
VALUES ('17', '电脑a', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('18', '电脑b', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('19', '电脑c', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('20', '电脑d', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('21', '电脑e', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('22', '电脑f', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('23', '电脑g', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('24', '电脑h', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('25', '电脑i', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('26', '电脑j', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('27', '电脑l', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('29', '电脑m', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('30', '电脑n', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('31', '电脑o', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('32', '电脑p', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('33', '电脑q', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW()),
       ('34', '电脑r', '电脑', '通用设备', '开发部门', '宝相公司', 10, 5000.00, DEFAULT, '已通过', NOW());
