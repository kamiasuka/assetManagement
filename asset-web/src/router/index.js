...
const routes = [
  {
    ...
    children:[
      ...
      {path:'/dept', component: () => import( '../views/home/DeptView'), meta: { breadcrumb: [ '部门管理'], }},
      ...
      {path:'/asset-category', component: () => import( '../views/home/AssetCategoryView'),meta: { breadcrumb: [ '资产分类'] }},
      {path:'/asset-manage', component: () => import( '../views/home/AssetManageView'),meta: { breadcrumb: [ '资产管理'] }},
    ]
  },
