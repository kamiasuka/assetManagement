...
const routes = [
  {
    ...
    children:[
      ...
      {path:'/asset-quary', component: () => import( '../views/home/assetManage/AssetQueryView'), meta: { breadcrumb: ['资产管理','资产查询'] }},
      ...
      {path:'/asset-value-change', component: () => import( '../views/home/assetManage/AssetValueChangeView'), meta: { breadcrumb: ['资产管理','价值变更'] }},
